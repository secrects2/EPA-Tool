export default function TermsPage() {
    return (
        <div className="max-w-3xl mx-auto py-12 px-6 text-slate-600 space-y-8">
            ...
            <section className="space-y-3">
                <h2 className="text-xl font-semibold text-slate-800">二、使用資格</h2>
            ...
            <section className="space-y-3">
                <h2 className="text-xl font-semibold text-slate-800">三、使用規範</h2>
                <ul className="list-disc pl-6 space-y-1 text-sm">
            ...
            <section className="space-y-3">
                <h2 className="text-xl font-semibold text-slate-800">四、免責聲明</h2>
                <ul className="list-disc pl-6 space-y-1 text-sm">
